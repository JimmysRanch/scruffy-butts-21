          ...
          <DialogContent className="max-w-md">
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  <Label htmlFor="edit-customer-state">State</Label>
                  <Select
                    value={customerForm.state}
                    onValueChange={(value) => setCustomerForm({ ...customerForm, state: value })}
                  >
                    <SelectTrigger id="edit-customer-state">
              ...
              <div>
                <Label htmlFor="edit-customer-zip">Zip Code</Label>
                <Input
                  id="edit-customer-zip"
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      ...
                      {(customer.city || customer.state || customer.zip) && (
                        <>{customer.city}{customer.city && (customer.state || customer.zip) ? ', ' : ''}{customer.state} {customer.zip}</>
                      )}
                    </p>
                  </div>
                </div>
